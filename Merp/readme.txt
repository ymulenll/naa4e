...
- execute the Update-Database command for the 'Merp.Accountancy.QueryStack' projects
- execute the Update-Database command for the 'Merp.Registry.QueryStack' projects